...
var file_pkg_server_server_proto_rawDesc = []byte{
	...
	0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x81, 0x07, 0x0a, 0x06, 0x52, 0x75,
	...
	0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x50, 0x61, 0x69, 0x72, 0x73, 0x22, 0x00, 0x42, 0x2e, 0x5a,
...
var file_pkg_server_server_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_pkg_server_server_proto_goTypes = []interface{}{
	...
	(*Pairs)(nil),             // 15: server.Pairs
	(*Empty)(nil),             // 16: server.Empty
	nil,                       // 17: server.Suites.DataEntry
	nil,                       // 18: server.TestTask.EnvEntry
}
var file_pkg_server_server_proto_depIdxs = []int32{
	17, // 0: server.Suites.data:type_name -> server.Suites.DataEntry
	18, // 1: server.TestTask.env:type_name -> server.TestTask.EnvEntry
	...
	14, // 13: server.Pairs.data:type_name -> server.Pair
	1,  // 14: server.Suites.DataEntry.value:type_name -> server.Items
	5,  // 15: server.Runner.Run:input_type -> server.TestTask
	16, // 16: server.Runner.Sample:input_type -> server.Empty
	16, // 17: server.Runner.GetVersion:input_type -> server.Empty
	16, // 18: server.Runner.GetSuites:input_type -> server.Empty
	4,  // 19: server.Runner.CreateTestSuite:input_type -> server.TestSuiteIdentity
	4,  // 20: server.Runner.GetTestSuite:input_type -> server.TestSuiteIdentity
	3,  // 21: server.Runner.UpdateTestSuite:input_type -> server.TestSuite
	4,  // 22: server.Runner.DeleteTestSuite:input_type -> server.TestSuiteIdentity
	4,  // 23: server.Runner.ListTestCase:input_type -> server.TestSuiteIdentity
	2,  // 24: server.Runner.RunTestCase:input_type -> server.TestCaseIdentity
	2,  // 25: server.Runner.GetTestCase:input_type -> server.TestCaseIdentity
	9,  // 26: server.Runner.CreateTestCase:input_type -> server.TestCaseWithSuite
	9,  // 27: server.Runner.UpdateTestCase:input_type -> server.TestCaseWithSuite
	2,  // 28: server.Runner.DeleteTestCase:input_type -> server.TestCaseIdentity
	16, // 29: server.Runner.PopularHeaders:input_type -> server.Empty
	6,  // 30: server.Runner.Run:output_type -> server.TestResult
	7,  // 31: server.Runner.Sample:output_type -> server.HelloReply
	7,  // 32: server.Runner.GetVersion:output_type -> server.HelloReply
	0,  // 33: server.Runner.GetSuites:output_type -> server.Suites
	7,  // 34: server.Runner.CreateTestSuite:output_type -> server.HelloReply
	3,  // 35: server.Runner.GetTestSuite:output_type -> server.TestSuite
	7,  // 36: server.Runner.UpdateTestSuite:output_type -> server.HelloReply
	7,  // 37: server.Runner.DeleteTestSuite:output_type -> server.HelloReply
	8,  // 38: server.Runner.ListTestCase:output_type -> server.Suite
	13, // 39: server.Runner.RunTestCase:output_type -> server.TestCaseResult
	10, // 40: server.Runner.GetTestCase:output_type -> server.TestCase
	7,  // 41: server.Runner.CreateTestCase:output_type -> server.HelloReply
	7,  // 42: server.Runner.UpdateTestCase:output_type -> server.HelloReply
	7,  // 43: server.Runner.DeleteTestCase:output_type -> server.HelloReply
	15, // 44: server.Runner.PopularHeaders:output_type -> server.Pairs
