...
var file_pkg_server_server_proto_rawDesc = []byte{
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xfd, 0x07, 0x0a, 0x06, 0x52, 0x75, 0x6e, 0x6e, 0x65, 0x72,
	0x12, 0x2d, 0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12, 0x10, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x2e, 0x54, 0x65, 0x73, 0x74, 0x54, 0x61, 0x73, 0x6b, 0x1a, 0x12, 0x2e, 0x73, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x12,
	...
	0x72, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x31,
	...
	0x79, 0x22, 0x00, 0x12, 0x3e, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73, 0x74, 0x53, 0x75,
	...
	0x41, 0x0a, 0x0b, 0x52, 0x75, 0x6e, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x12, 0x18,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65,
	...
	0x22, 0x00, 0x12, 0x3b, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73,
	...
	0x41, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73,
	...
	0x22, 0x00, 0x12, 0x41, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x65, 0x73, 0x74,
	...
	0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x40, 0x0a, 0x0e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x54,
	...
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x30, 0x0a, 0x0e, 0x50, 0x6f, 0x70, 0x75, 0x6c,
	...
	0x72, 0x2e, 0x50, 0x61, 0x69, 0x72, 0x73, 0x22, 0x00, 0x12, 0x42, 0x0a, 0x10, 0x47, 0x65, 0x74,
	...
	0x72, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x73, 0x22, 0x00, 0x12, 0x36, 0x0a,
	...
	0x69, 0x72, 0x73, 0x22, 0x00, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_pkg_server_server_proto_depIdxs = []int32{
	...
	21, // 2: server.TestTask.env:type_name -> server.TestTask.EnvEntry
	...
	19, // 18: server.Runner.Sample:input_type -> server.Empty
	19, // 19: server.Runner.GetVersion:input_type -> server.Empty
	19, // 20: server.Runner.GetSuites:input_type -> server.Empty
	...
	19, // 31: server.Runner.PopularHeaders:input_type -> server.Empty
	5,  // 32: server.Runner.GetSuggestedAPIs:input_type -> server.TestSuiteIdentity
	18, // 33: server.Runner.FunctionsQuery:input_type -> server.SimpleQuery
	7,  // 34: server.Runner.Run:output_type -> server.TestResult
	8,  // 35: server.Runner.Sample:output_type -> server.HelloReply
	8,  // 36: server.Runner.GetVersion:output_type -> server.HelloReply
	0,  // 37: server.Runner.GetSuites:output_type -> server.Suites
	8,  // 38: server.Runner.CreateTestSuite:output_type -> server.HelloReply
	3,  // 39: server.Runner.GetTestSuite:output_type -> server.TestSuite
	8,  // 40: server.Runner.UpdateTestSuite:output_type -> server.HelloReply
	8,  // 41: server.Runner.DeleteTestSuite:output_type -> server.HelloReply
	9,  // 42: server.Runner.ListTestCase:output_type -> server.Suite
	15, // 43: server.Runner.RunTestCase:output_type -> server.TestCaseResult
	12, // 44: server.Runner.GetTestCase:output_type -> server.TestCase
	8,  // 45: server.Runner.CreateTestCase:output_type -> server.HelloReply
	8,  // 46: server.Runner.UpdateTestCase:output_type -> server.HelloReply
	8,  // 47: server.Runner.DeleteTestCase:output_type -> server.HelloReply
	17, // 48: server.Runner.PopularHeaders:output_type -> server.Pairs
	11, // 49: server.Runner.GetSuggestedAPIs:output_type -> server.TestCases
	17, // 50: server.Runner.FunctionsQuery:output_type -> server.Pairs
