...
var file_pkg_server_server_proto_rawDesc = []byte{
	...
	0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x77,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x73, 0x65,
	...
	0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0x6a, 0x0a,
	...
	0x72, 0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x22, 0xce, 0x01, 0x0a, 0x08, 0x52, 0x65,
	...
	0x70, 0x74, 0x79, 0x32, 0x8a, 0x03, 0x0a, 0x06, 0x52, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x12, 0x2d,
	...
	0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x31, 0x0a, 0x0a,
	...
	0x72, 0x76, 0x65, 0x72, 0x2e, 0x53, 0x75, 0x69, 0x74, 0x65, 0x73, 0x22, 0x00, 0x12, 0x41, 0x0a,
...
var file_pkg_server_server_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_pkg_server_server_proto_goTypes = []interface{}{
	...
	(*TestCaseWithSuite)(nil), // 6: server.TestCaseWithSuite
	(*TestCase)(nil),          // 7: server.TestCase
	(*Request)(nil),           // 8: server.Request
	(*TestCaseResult)(nil),    // 9: server.TestCaseResult
	(*Response)(nil),          // 10: server.Response
	(*Pair)(nil),              // 11: server.Pair
	(*Empty)(nil),             // 12: server.Empty
	nil,                       // 13: server.Suites.DataEntry
	nil,                       // 14: server.TestTask.EnvEntry
}
var file_pkg_server_server_proto_depIdxs = []int32{
	13, // 0: server.Suites.data:type_name -> server.Suites.DataEntry
	14, // 1: server.TestTask.env:type_name -> server.TestTask.EnvEntry
	7,  // 2: server.Suite.items:type_name -> server.TestCase
	7,  // 3: server.TestCaseWithSuite.data:type_name -> server.TestCase
	8,  // 4: server.TestCase.request:type_name -> server.Request
	10, // 5: server.TestCase.response:type_name -> server.Response
	11, // 6: server.Request.header:type_name -> server.Pair
	11, // 7: server.Request.query:type_name -> server.Pair
	11, // 8: server.Request.form:type_name -> server.Pair
	11, // 9: server.TestCaseResult.header:type_name -> server.Pair
	11, // 10: server.Response.header:type_name -> server.Pair
	11, // 11: server.Response.bodyFieldsExpect:type_name -> server.Pair
	1,  // 12: server.Suites.DataEntry.value:type_name -> server.Items
	3,  // 13: server.Runner.Run:input_type -> server.TestTask
	12, // 14: server.Runner.Sample:input_type -> server.Empty
	12, // 15: server.Runner.GetVersion:input_type -> server.Empty
	12, // 16: server.Runner.GetSuites:input_type -> server.Empty
	...
	6,  // 19: server.Runner.UpdateTestCase:input_type -> server.TestCaseWithSuite
	4,  // 20: server.Runner.Run:output_type -> server.HelloReply
	4,  // 21: server.Runner.Sample:output_type -> server.HelloReply
	4,  // 22: server.Runner.GetVersion:output_type -> server.HelloReply
	0,  // 23: server.Runner.GetSuites:output_type -> server.Suites
	9,  // 24: server.Runner.RunTestCase:output_type -> server.TestCaseResult
	7,  // 25: server.Runner.GetTestCase:output_type -> server.TestCase
	4,  // 26: server.Runner.UpdateTestCase:output_type -> server.HelloReply
