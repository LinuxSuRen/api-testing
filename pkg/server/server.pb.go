...
var file_pkg_server_server_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0xa1, 0x25, 0x0a, 0x06, 0x52, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x12, 0x43, 0x0a, 0x03,
	...
	0x75, 0x65, 0x72, 0x79, 0x28, 0x01, 0x30, 0x01, 0x12, 0x45, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x56,
	...
	,
...
var file_pkg_server_server_proto_depIdxs = []int32{
	...
	49,  // 101: server.Mock.Reload:input_type -> server.MockConfig
	48,  // 102: server.Mock.GetConfig:input_type -> server.Empty
	52,  // 103: server.DataServer.Query:input_type -> server.DataQuery
	17,  // 104: server.Runner.Run:output_type -> server.TestResult
	17,  // 105: server.Runner.RunTestSuite:output_type -> server.TestResult
	0,   // 106: server.Runner.GetSuites:output_type -> server.Suites
	19,  // 107: server.Runner.CreateTestSuite:output_type -> server.HelloReply
	38,  // 108: server.Runner.ImportTestSuite:output_type -> server.CommonResult
	7,   // 109: server.Runner.GetTestSuite:output_type -> server.TestSuite
	19,  // 110: server.Runner.UpdateTestSuite:output_type -> server.HelloReply
	19,  // 111: server.Runner.DeleteTestSuite:output_type -> server.HelloReply
	19,  // 112: server.Runner.DuplicateTestSuite:output_type -> server.HelloReply
	19,  // 113: server.Runner.RenameTestSuite:output_type -> server.HelloReply
	20,  // 114: server.Runner.GetTestSuiteYaml:output_type -> server.YamlData
	21,  // 115: server.Runner.ListTestCase:output_type -> server.Suite
	30,  // 116: server.Runner.RunTestCase:output_type -> server.TestCaseResult
	17,  // 117: server.Runner.BatchRun:output_type -> server.TestResult
	24,  // 118: server.Runner.GetTestCase:output_type -> server.TestCase
	19,  // 119: server.Runner.CreateTestCase:output_type -> server.HelloReply
	19,  // 120: server.Runner.UpdateTestCase:output_type -> server.HelloReply
	19,  // 121: server.Runner.DeleteTestCase:output_type -> server.HelloReply
	19,  // 122: server.Runner.DuplicateTestCase:output_type -> server.HelloReply
	19,  // 123: server.Runner.RenameTestCase:output_type -> server.HelloReply
	23,  // 124: server.Runner.GetSuggestedAPIs:output_type -> server.TestCases
	2,   // 125: server.Runner.GetHistorySuites:output_type -> server.HistorySuites
	18,  // 126: server.Runner.GetHistoryTestCaseWithResult:output_type -> server.HistoryTestResult
	25,  // 127: server.Runner.GetHistoryTestCase:output_type -> server.HistoryTestCase
	19,  // 128: server.Runner.DeleteHistoryTestCase:output_type -> server.HelloReply
	19,  // 129: server.Runner.DeleteAllHistoryTestCase:output_type -> server.HelloReply
	26,  // 130: server.Runner.GetTestCaseAllHistory:output_type -> server.HistoryTestCases
	39,  // 131: server.Runner.ListCodeGenerator:output_type -> server.SimpleList
	38,  // 132: server.Runner.GenerateCode:output_type -> server.CommonResult
	38,  // 133: server.Runner.HistoryGenerateCode:output_type -> server.CommonResult
	39,  // 134: server.Runner.ListConverter:output_type -> server.SimpleList
	38,  // 135: server.Runner.ConvertTestSuite:output_type -> server.CommonResult
	32,  // 136: server.Runner.PopularHeaders:output_type -> server.Pairs
	32,  // 137: server.Runner.FunctionsQuery:output_type -> server.Pairs
	32,  // 138: server.Runner.FunctionsQueryStream:output_type -> server.Pairs
	50,  // 139: server.Runner.GetVersion:output_type -> server.Version
	19,  // 140: server.Runner.Sample:output_type -> server.HelloReply
	47,  // 141: server.Runner.DownloadResponseFile:output_type -> server.FileData
	36,  // 142: server.Runner.GetStoreKinds:output_type -> server.StoreKinds
	34,  // 143: server.Runner.GetStores:output_type -> server.Stores
	35,  // 144: server.Runner.CreateStore:output_type -> server.Store
	35,  // 145: server.Runner.UpdateStore:output_type -> server.Store
	35,  // 146: server.Runner.DeleteStore:output_type -> server.Store
	44,  // 147: server.Runner.VerifyStore:output_type -> server.ExtensionStatus
	42,  // 148: server.Runner.GetSecrets:output_type -> server.Secrets
	38,  // 149: server.Runner.CreateSecret:output_type -> server.CommonResult
	38,  // 150: server.Runner.DeleteSecret:output_type -> server.CommonResult
	38,  // 151: server.Runner.UpdateSecret:output_type -> server.CommonResult
	46,  // 152: server.Runner.PProf:output_type -> server.PProfData
	38,  // 153: server.RunnerExtension.Run:output_type -> server.CommonResult
	48,  // 154: server.Mock.Reload:output_type -> server.Empty
	49,  // 155: server.Mock.GetConfig:output_type -> server.MockConfig
	53,  // 156: server.DataServer.Query:output_type -> server.DataQueryResult
	104, // [104:157] is the sub-list for method output_type
	51,  // [51:104] is the sub-list for method input_type
