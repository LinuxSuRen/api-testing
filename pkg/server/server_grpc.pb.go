...
type UIExtensionClient interface {
	...
	GetPageOfServer(ctx context.Context, in *SimpleName, opts ...grpc.CallOption) (*CommonResult, error)
}
...
func (c *uIExtensionClient) GetPageOfServer(ctx context.Context, in *SimpleName, opts ...grpc.CallOption) (*CommonResult, error) {
	out := new(CommonResult)
	err := c.cc.Invoke(ctx, "/server.UIExtension/GetPageOfServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UIExtensionServer interface {
	...
	GetPageOfServer(context.Context, *SimpleName) (*CommonResult, error)
...
func (UnimplementedUIExtensionServer) GetPageOfServer(context.Context, *SimpleName) (*CommonResult, error) {
...
func _UIExtension_GetPageOfServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SimpleName)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UIExtensionServer).GetPageOfServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/server.UIExtension/GetPageOfServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UIExtensionServer).GetPageOfServer(ctx, req.(*SimpleName))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UIExtension_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UIExtension_GetPageOfServer_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/server/server.proto",
