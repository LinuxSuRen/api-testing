...
var file_pkg_testing_remote_loader_proto_goTypes = []any{
	...
	(*server.GenerateSQLRequest)(nil),     // 17: server.GenerateSQLRequest
	(*server.ValidateSQLRequest)(nil),     // 18: server.ValidateSQLRequest
	(*server.Secret)(nil),                 // 19: server.Secret
	(*server.HelloReply)(nil),             // 20: server.HelloReply
	(*server.TestCases)(nil),              // 21: server.TestCases
	(*server.HistoryTestCases)(nil),       // 22: server.HistoryTestCases
	(*server.Version)(nil),                // 23: server.Version
	(*server.ExtensionStatus)(nil),        // 24: server.ExtensionStatus
	(*server.PProfData)(nil),              // 25: server.PProfData
	(*server.DataQueryResult)(nil),        // 26: server.DataQueryResult
	(*server.SimpleList)(nil),             // 27: server.SimpleList
	(*server.CommonResult)(nil),           // 28: server.CommonResult
	(*server.MenuList)(nil),               // 29: server.MenuList
	(*server.GenerateSQLResponse)(nil),    // 30: server.GenerateSQLResponse
	(*server.ValidateSQLResponse)(nil),    // 31: server.ValidateSQLResponse
	(*server.AICapabilitiesResponse)(nil), // 32: server.AICapabilitiesResponse
	(*server.Secrets)(nil),                // 33: server.Secrets
}
var file_pkg_testing_remote_loader_proto_depIdxs = []int32{
	...
	17, // 38: remote.Loader.GenerateSQL:input_type -> server.GenerateSQLRequest
	18, // 39: remote.Loader.ValidateSQL:input_type -> server.ValidateSQLRequest
	10, // 40: remote.Loader.GetAICapabilities:input_type -> server.Empty
	19, // 41: remote.SecretService.GetSecret:input_type -> server.Secret
	10, // 42: remote.SecretService.GetSecrets:input_type -> server.Empty
	19, // 43: remote.SecretService.CreateSecret:input_type -> server.Secret
	19, // 44: remote.SecretService.DeleteSecret:input_type -> server.Secret
	19, // 45: remote.SecretService.UpdateSecret:input_type -> server.Secret
	10, // 46: remote.ConfigService.GetConfigs:input_type -> server.Empty
	16, // 47: remote.ConfigService.GetConfig:input_type -> server.SimpleName
	5,  // 48: remote.ConfigService.CreateConfig:input_type -> remote.Config
	5,  // 49: remote.ConfigService.UpdateConfig:input_type -> remote.Config
	16, // 50: remote.ConfigService.DeleteConfig:input_type -> server.SimpleName
	0,  // 51: remote.Loader.ListTestSuite:output_type -> remote.TestSuites
	10, // 52: remote.Loader.CreateTestSuite:output_type -> server.Empty
	1,  // 53: remote.Loader.GetTestSuite:output_type -> remote.TestSuite
	1,  // 54: remote.Loader.UpdateTestSuite:output_type -> remote.TestSuite
	10, // 55: remote.Loader.DeleteTestSuite:output_type -> server.Empty
	20, // 56: remote.Loader.RenameTestSuite:output_type -> server.HelloReply
	21, // 57: remote.Loader.ListTestCases:output_type -> server.TestCases
	10, // 58: remote.Loader.CreateTestCase:output_type -> server.Empty
	8,  // 59: remote.Loader.GetTestCase:output_type -> server.TestCase
	8,  // 60: remote.Loader.UpdateTestCase:output_type -> server.TestCase
	10, // 61: remote.Loader.DeleteTestCase:output_type -> server.Empty
	20, // 62: remote.Loader.RenameTestCase:output_type -> server.HelloReply
	2,  // 63: remote.Loader.ListHistoryTestSuite:output_type -> remote.HistoryTestSuites
	10, // 64: remote.Loader.CreateTestCaseHistory:output_type -> server.Empty
	13, // 65: remote.Loader.GetHistoryTestCaseWithResult:output_type -> server.HistoryTestResult
	9,  // 66: remote.Loader.GetHistoryTestCase:output_type -> server.HistoryTestCase
	10, // 67: remote.Loader.DeleteHistoryTestCase:output_type -> server.Empty
	10, // 68: remote.Loader.DeleteAllHistoryTestCase:output_type -> server.Empty
	22, // 69: remote.Loader.GetTestCaseAllHistory:output_type -> server.HistoryTestCases
	23, // 70: remote.Loader.GetVersion:output_type -> server.Version
	24, // 71: remote.Loader.Verify:output_type -> server.ExtensionStatus
	25, // 72: remote.Loader.PProf:output_type -> server.PProfData
	26, // 73: remote.Loader.Query:output_type -> server.DataQueryResult
	27, // 74: remote.Loader.GetThemes:output_type -> server.SimpleList
	28, // 75: remote.Loader.GetTheme:output_type -> server.CommonResult
	27, // 76: remote.Loader.GetBindings:output_type -> server.SimpleList
	28, // 77: remote.Loader.GetBinding:output_type -> server.CommonResult
	29, // 78: remote.Loader.GetMenus:output_type -> server.MenuList
	28, // 79: remote.Loader.GetPageOfJS:output_type -> server.CommonResult
	28, // 80: remote.Loader.GetPageOfCSS:output_type -> server.CommonResult
	28, // 81: remote.Loader.GetPageOfStatic:output_type -> server.CommonResult
	30, // 82: remote.Loader.GenerateSQL:output_type -> server.GenerateSQLResponse
	31, // 83: remote.Loader.ValidateSQL:output_type -> server.ValidateSQLResponse
	32, // 84: remote.Loader.GetAICapabilities:output_type -> server.AICapabilitiesResponse
	19, // 85: remote.SecretService.GetSecret:output_type -> server.Secret
	33, // 86: remote.SecretService.GetSecrets:output_type -> server.Secrets
	28, // 87: remote.SecretService.CreateSecret:output_type -> server.CommonResult
	28, // 88: remote.SecretService.DeleteSecret:output_type -> server.CommonResult
	28, // 89: remote.SecretService.UpdateSecret:output_type -> server.CommonResult
	4,  // 90: remote.ConfigService.GetConfigs:output_type -> remote.Configs
	5,  // 91: remote.ConfigService.GetConfig:output_type -> remote.Config
	28, // 92: remote.ConfigService.CreateConfig:output_type -> server.CommonResult
	28, // 93: remote.ConfigService.UpdateConfig:output_type -> server.CommonResult
	28, // 94: remote.ConfigService.DeleteConfig:output_type -> server.CommonResult
