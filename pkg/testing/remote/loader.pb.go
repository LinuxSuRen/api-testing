...
=======
	0x6d, 0x73, 0x32, 0xca, 0x08, 0x0a, 0x06, 0x4c, 0x6f, 0x61, 0x64, 0x65, 0x72, 0x12, 0x34, 0x0a,
...
=======
	0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x54, 0x0a,
	...
	0x74, 0x22, 0x00, 0x12, 0x48, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72,
	...
	0x6f, 0x72, 0x79, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x22, 0x00, 0x12, 0x41, 0x0a,
	...
	0x12, 0x45, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x41,
	...
	0x43, 0x61, 0x73, 0x65, 0x73, 0x22, 0x00, 0x12, 0x32, 0x0a, 0x06, 0x56, 0x65, 0x72, 0x69, 0x66,
	...
	0x12, 0x0e, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74,
	0x1a, 0x14, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68,
	...
	0x67, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2f, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65,
...
=======
	...
	(*server.HistoryTestCase)(nil),   // 7: server.HistoryTestCase
	(*server.Empty)(nil),             // 8: server.Empty
	(*server.HistoryTestResult)(nil), // 9: server.HistoryTestResult
	(*server.PProfRequest)(nil),      // 10: server.PProfRequest
	(*server.Secret)(nil),            // 11: server.Secret
	(*server.TestCases)(nil),         // 12: server.TestCases
	(*server.HistoryTestCases)(nil),  // 13: server.HistoryTestCases
	(*server.ExtensionStatus)(nil),   // 14: server.ExtensionStatus
	(*server.PProfData)(nil),         // 15: server.PProfData
	(*server.Secrets)(nil),           // 16: server.Secrets
	(*server.CommonResult)(nil),      // 17: server.CommonResult
>>>>>>> 6c2cd54 (feat: add history case revert api and ui)
}
...
=======
	7,  // 18: remote.Loader.GetHistoryTestCaseWithResult:input_type -> server.HistoryTestCase
	7,  // 19: remote.Loader.GetHistoryTestCase:input_type -> server.HistoryTestCase
	7,  // 20: remote.Loader.DeleteHistoryTestCase:input_type -> server.HistoryTestCase
	6,  // 21: remote.Loader.GetTestCaseAllHistory:input_type -> server.TestCase
	8,  // 22: remote.Loader.Verify:input_type -> server.Empty
	10, // 23: remote.Loader.PProf:input_type -> server.PProfRequest
	11, // 24: remote.SecretService.GetSecret:input_type -> server.Secret
	8,  // 25: remote.SecretService.GetSecrets:input_type -> server.Empty
	11, // 26: remote.SecretService.CreateSecret:input_type -> server.Secret
	11, // 27: remote.SecretService.DeleteSecret:input_type -> server.Secret
	11, // 28: remote.SecretService.UpdateSecret:input_type -> server.Secret
	0,  // 29: remote.Loader.ListTestSuite:output_type -> remote.TestSuites
	8,  // 30: remote.Loader.CreateTestSuite:output_type -> server.Empty
	1,  // 31: remote.Loader.GetTestSuite:output_type -> remote.TestSuite
	1,  // 32: remote.Loader.UpdateTestSuite:output_type -> remote.TestSuite
	8,  // 33: remote.Loader.DeleteTestSuite:output_type -> server.Empty
	12, // 34: remote.Loader.ListTestCases:output_type -> server.TestCases
	8,  // 35: remote.Loader.CreateTestCase:output_type -> server.Empty
	6,  // 36: remote.Loader.GetTestCase:output_type -> server.TestCase
	6,  // 37: remote.Loader.UpdateTestCase:output_type -> server.TestCase
	8,  // 38: remote.Loader.DeleteTestCase:output_type -> server.Empty
	2,  // 39: remote.Loader.ListHistoryTestSuite:output_type -> remote.HistoryTestSuites
	8,  // 40: remote.Loader.CreateTestCaseHistory:output_type -> server.Empty
	9,  // 41: remote.Loader.GetHistoryTestCaseWithResult:output_type -> server.HistoryTestResult
	7,  // 42: remote.Loader.GetHistoryTestCase:output_type -> server.HistoryTestCase
	8,  // 43: remote.Loader.DeleteHistoryTestCase:output_type -> server.Empty
	13, // 44: remote.Loader.GetTestCaseAllHistory:output_type -> server.HistoryTestCases
	14, // 45: remote.Loader.Verify:output_type -> server.ExtensionStatus
	15, // 46: remote.Loader.PProf:output_type -> server.PProfData
	11, // 47: remote.SecretService.GetSecret:output_type -> server.Secret
	16, // 48: remote.SecretService.GetSecrets:output_type -> server.Secrets
	17, // 49: remote.SecretService.CreateSecret:output_type -> server.CommonResult
	17, // 50: remote.SecretService.DeleteSecret:output_type -> server.CommonResult
	17, // 51: remote.SecretService.UpdateSecret:output_type -> server.CommonResult
