...
type LoaderClient interface {
	...
	GetPageOfServer(ctx context.Context, in *server.SimpleName, opts ...grpc.CallOption) (*server.CommonResult, error)
}
...
func (c *loaderClient) GetPageOfServer(ctx context.Context, in *server.SimpleName, opts ...grpc.CallOption) (*server.CommonResult, error) {
	out := new(server.CommonResult)
	err := c.cc.Invoke(ctx, "/remote.Loader/GetPageOfServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LoaderServer interface {
	...
	GetPageOfServer(context.Context, *server.SimpleName) (*server.CommonResult, error)
...
func (UnimplementedLoaderServer) GetPageOfServer(context.Context, *server.SimpleName) (*server.CommonResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPageOfServer not implemented")
}
...
func _Loader_GetPageOfServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(server.SimpleName)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoaderServer).GetPageOfServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/remote.Loader/GetPageOfServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoaderServer).GetPageOfServer(ctx, req.(*server.SimpleName))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Loader_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPageOfServer",
			Handler:    _Loader_GetPageOfServer_Handler,
		},
	},
