...
var file_pkg_server_server_proto_depIdxs = []int32{
	...
	52,  // 110: server.ThemeExtension.GetThemes:input_type -> server.Empty
	44,  // 111: server.ThemeExtension.GetTheme:input_type -> server.SimpleName
	52,  // 112: server.ThemeExtension.GetBindings:input_type -> server.Empty
	44,  // 113: server.ThemeExtension.GetBinding:input_type -> server.SimpleName
	53,  // 114: server.Mock.Reload:input_type -> server.MockConfig
	52,  // 115: server.Mock.GetConfig:input_type -> server.Empty
	52,  // 116: server.Mock.LogWatch:input_type -> server.Empty
	56,  // 117: server.DataServer.Query:input_type -> server.DataQuery
	59,  // 118: server.AIService.ConvertNLToSQL:input_type -> server.AIRequest
	59,  // 119: server.AIService.GenerateTestCase:input_type -> server.AIRequest
	59,  // 120: server.AIService.OptimizeQuery:input_type -> server.AIRequest
	52,  // 121: server.AIService.HealthCheck:input_type -> server.Empty
	19,  // 122: server.Runner.Run:output_type -> server.TestResult
	19,  // 123: server.Runner.RunTestSuite:output_type -> server.TestResult
	2,   // 124: server.Runner.GetSuites:output_type -> server.Suites
	21,  // 125: server.Runner.CreateTestSuite:output_type -> server.HelloReply
	42,  // 126: server.Runner.ImportTestSuite:output_type -> server.CommonResult
	9,   // 127: server.Runner.GetTestSuite:output_type -> server.TestSuite
	21,  // 128: server.Runner.UpdateTestSuite:output_type -> server.HelloReply
	21,  // 129: server.Runner.DeleteTestSuite:output_type -> server.HelloReply
	21,  // 130: server.Runner.DuplicateTestSuite:output_type -> server.HelloReply
	21,  // 131: server.Runner.RenameTestSuite:output_type -> server.HelloReply
	22,  // 132: server.Runner.GetTestSuiteYaml:output_type -> server.YamlData
	23,  // 133: server.Runner.ListTestCase:output_type -> server.Suite
	32,  // 134: server.Runner.RunTestCase:output_type -> server.TestCaseResult
	19,  // 135: server.Runner.BatchRun:output_type -> server.TestResult
	26,  // 136: server.Runner.GetTestCase:output_type -> server.TestCase
	21,  // 137: server.Runner.CreateTestCase:output_type -> server.HelloReply
	21,  // 138: server.Runner.UpdateTestCase:output_type -> server.HelloReply
	21,  // 139: server.Runner.DeleteTestCase:output_type -> server.HelloReply
	21,  // 140: server.Runner.DuplicateTestCase:output_type -> server.HelloReply
	21,  // 141: server.Runner.RenameTestCase:output_type -> server.HelloReply
	25,  // 142: server.Runner.GetSuggestedAPIs:output_type -> server.TestCases
	4,   // 143: server.Runner.GetHistorySuites:output_type -> server.HistorySuites
	20,  // 144: server.Runner.GetHistoryTestCaseWithResult:output_type -> server.HistoryTestResult
	27,  // 145: server.Runner.GetHistoryTestCase:output_type -> server.HistoryTestCase
	21,  // 146: server.Runner.DeleteHistoryTestCase:output_type -> server.HelloReply
	21,  // 147: server.Runner.DeleteAllHistoryTestCase:output_type -> server.HelloReply
	28,  // 148: server.Runner.GetTestCaseAllHistory:output_type -> server.HistoryTestCases
	43,  // 149: server.Runner.ListCodeGenerator:output_type -> server.SimpleList
	42,  // 150: server.Runner.GenerateCode:output_type -> server.CommonResult
	42,  // 151: server.Runner.HistoryGenerateCode:output_type -> server.CommonResult
	43,  // 152: server.Runner.ListConverter:output_type -> server.SimpleList
	42,  // 153: server.Runner.ConvertTestSuite:output_type -> server.CommonResult
	34,  // 154: server.Runner.PopularHeaders:output_type -> server.Pairs
	34,  // 155: server.Runner.FunctionsQuery:output_type -> server.Pairs
	34,  // 156: server.Runner.FunctionsQueryStream:output_type -> server.Pairs
	42,  // 157: server.Runner.GetSchema:output_type -> server.CommonResult
	54,  // 158: server.Runner.GetVersion:output_type -> server.Version
	21,  // 159: server.Runner.Sample:output_type -> server.HelloReply
	51,  // 160: server.Runner.DownloadResponseFile:output_type -> server.FileData
	38,  // 161: server.Runner.GetStoreKinds:output_type -> server.StoreKinds
	36,  // 162: server.Runner.GetStores:output_type -> server.Stores
	37,  // 163: server.Runner.CreateStore:output_type -> server.Store
	37,  // 164: server.Runner.UpdateStore:output_type -> server.Store
	37,  // 165: server.Runner.DeleteStore:output_type -> server.Store
	48,  // 166: server.Runner.VerifyStore:output_type -> server.ExtensionStatus
	46,  // 167: server.Runner.GetSecrets:output_type -> server.Secrets
	42,  // 168: server.Runner.CreateSecret:output_type -> server.CommonResult
	42,  // 169: server.Runner.DeleteSecret:output_type -> server.CommonResult
	42,  // 170: server.Runner.UpdateSecret:output_type -> server.CommonResult
	50,  // 171: server.Runner.PProf:output_type -> server.PProfData
	42,  // 172: server.RunnerExtension.Run:output_type -> server.CommonResult
	1,   // 173: server.UIExtension.GetMenus:output_type -> server.MenuList
	42,  // 174: server.UIExtension.GetPageOfJS:output_type -> server.CommonResult
	42,  // 175: server.UIExtension.GetPageOfCSS:output_type -> server.CommonResult
	...
	60,  // 184: server.AIService.ConvertNLToSQL:output_type -> server.AIResponse
	60,  // 185: server.AIService.GenerateTestCase:output_type -> server.AIResponse
	60,  // 186: server.AIService.OptimizeQuery:output_type -> server.AIResponse
	61,  // 187: server.AIService.HealthCheck:output_type -> server.AIHealthResponse
